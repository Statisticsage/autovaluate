  ...
  return (
    <div className={styles.app}>
      ...
      <main className={styles.main}>
        <HeroSection onGetStarted={() => formRef.current?.scrollIntoView({ behavior: 'smooth', block: 'start' })} />
            ...
            {result && (
              <div className={styles.resultContent}>
                ...
                <p className={styles.disclaimer}>
                  Estimates are generated by a machine learning model trained on real second-hand car listings (India, 2014–2020). Actual market prices vary by location, vehicle condition, and demand — use this as a reference point, not a final valuation.
                </p>
              </div>
            )}
